...
dihard_dev_2019_path=/home/data1/SRE18/harshav/dihard_2018/v2/data/DEV_2019
dihard_eval_2019_path=/home/data1/SRE18/harshav/dihard_2018/v2/data/EVAL_2019
...
if [ $# != 0 ]; then
  ...
  echo "  --dihard_dev_2019_path            # path of downloaded DIHARD 2019 development dataset"
  echo "  --dihard_eval_2019_path           # path of downloaded DIHARD 2019 evaluation dataset"
  exit 1;
fi
...
if [ $tracknum -eq 2 ]; then
    ...
    perl md_eval.pl -r data/dihard_dev_new6/rttm \
     -s $nnet_dir/xvectors_${dihard_dev}/plda_scores_t$threshold/rttm \
     2> $nnet_dir/tuning_$track/${dihard_dev}_t${threshold}.log \
     > $nnet_dir/tuning_$track/${dihard_dev}_t${threshold}
