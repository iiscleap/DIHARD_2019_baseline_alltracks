...
# Denoise WAV.                                                                                   
DEV_WAV_DEN_DIR=exp/dihard_dev_2019_multichan_wav_den
...
EVAL_WAV_DEN_DIR=exp/dihard_eval_2019_multichan_wav_den
...
# Perform VAD.
DEV_VAD_DIR=exp/dihard_dev_2019_multichan_vad_den
...
EVAL_VAD_DIR=exp/dihard_eval_2019_multichan_vad_den
...
# Diarize.
echo "Diarizing..."
./alltracksrun.sh --tracknum 4_den --plda_path exp/xvector_nnet_1a/plda_track4

# Extract dev/eval RTTM files.
echo "Extracting RTTM files..."
DEV_RTTM_DIR=$THIS_DIR/rttm_dev
local/split_rttm.py \
    exp/xvector_nnet_1a/xvectors_dihard_dev_2019_track4_den/plda_scores/rttm $DEV_RTTM_DIR
EVAL_RTTM_DIR=$THIS_DIR/rttm_eval
local/split_rttm.py \
    exp/xvector_nnet_1a/xvectors_dihard_eval_2019_track4_den/plda_scores/rttm $EVAL_RTTM_DIR
