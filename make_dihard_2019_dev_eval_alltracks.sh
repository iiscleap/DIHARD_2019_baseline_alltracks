...
# 		echo "Preparing ${data_dir}..."
# 		local/make_dihard_2019_dev_eval_alltracks.py ${path_to_dihard_2019_dev_track2} ${data_dir} $tracknum $devoreval
# 		sort -k 2,2 -s ${data_dir}/rttm > ${data_dir}/rttm_tmp
# 		mv ${data_dir}/rttm_tmp ${data_dir}/rttm
# 		sort -k 1,1 -s ${data_dir}/reco2num_spk > ${data_dir}/reco2num_spk_tmp
# 		mv ${data_dir}/reco2num_spk_tmp ${data_dir}/reco2num_spk
...
# 	elif [ "$devoreval" = "eval" ]; then
# 		path_to_dihard_2018_eval_track2=$1

# 		echo "Preparing ${data_dir}..."
# 		local/make_dihard_2019_dev_eval_alltracks.py ${path_to_dihard_2018_eval_track2} ${data_dir} $tracknum $devoreval
# 		utils/fix_data_dir.sh ${data_dir}
# 	fi
# fi
